...
MASCP.CondensedSequenceRenderer.prototype.createModhunterLayer = function() {
    ...
    this._layer_containers.modhunter.track_height = 9;

    return this;
};

/**
 * Function to create rects that color the modhunter according to residue scores
 */
MASCP.CondensedSequenceRenderer.prototype.fillModhunter = function(modhunterObject) {
    ...
    var scrToColor = function(scr) {
        var colorStr = '' + 255-(Math.round((scr/100)*255))
        return ('rgb(255,' + colorStr + ',' + colorStr + ')');
    }
...
var addElementToLayer = function(layerName) {
	...
	var tracer_marker = canvas.marker(this._index+0.3,10,0.5,'GLY');
    }else{ 
